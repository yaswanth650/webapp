...
module RbConfig
  ...
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/opt/inspec/embedded")
  ...
  CONFIG["configure_args"] = " '--prefix=/opt/inspec/embedded' '--without-ext=dbm,readline' '--enable-shared' '--disable-install-doc' '--without-gmp' '--without-gdbm' '--without-tk' '--disable-dtrace' '--with-opt-dir=/opt/inspec/embedded' 'CFLAGS=-I/opt/inspec/embedded/include -O2 -O3 -g -pipe' 'LDFLAGS=-Wl,-rpath,/opt/inspec/embedded/lib -L/opt/inspec/embedded/lib' 'CPPFLAGS=-I/opt/inspec/embedded/include -O2 -O3 -g -pipe' 'CXXFLAGS=-I/opt/inspec/embedded/include -O2 -O3 -g -pipe'"
  ...
  CONFIG["RUBY_EXEC_PREFIX"] = "/opt/inspec/embedded"
  ...
  CONFIG["STATIC"] = ""
  CONFIG["ARCH_FLAG"] = ""
  CONFIG["DLDFLAGS"] = "-Wl,-rpath,/opt/inspec/embedded/lib -L/opt/inspec/embedded/lib -L/opt/inspec/embedded/lib  -Wl,-rpath,/opt/inspec/embedded/lib"
  CONFIG["ALLOCA"] = ""
  CONFIG["dsymutil"] = ""
  CONFIG["codesign"] = ""
  CONFIG["POSTLINK"] = ":"
  ...
  CONFIG["CPP"] = "$(CC) -E"
  CONFIG["CXXFLAGS"] = "-I/opt/inspec/embedded/include -O2 -O3 -g -pipe"
  CONFIG["CXX"] = "g++"
  CONFIG["OBJEXT"] = "o"
  CONFIG["CPPFLAGS"] = "-I/opt/inspec/embedded/include -O2 -O3 -g -pipe -I/opt/inspec/embedded/include $(DEFS) $(cppflags)"
  CONFIG["LDFLAGS"] = "-L. -Wl,-rpath,/opt/inspec/embedded/lib -L/opt/inspec/embedded/lib -fstack-protector -rdynamic -Wl,-export-dynamic -L/opt/inspec/embedded/lib  -Wl,-rpath,/opt/inspec/embedded/lib"
  CONFIG["CFLAGS"] = "-I/opt/inspec/embedded/include -O2 -O3 -g -pipe -fPIC"
  CONFIG["CC"] = "gcc"
